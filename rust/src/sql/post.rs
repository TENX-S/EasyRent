pub const ADD_RENT_POST: &str = r#"
    INSERT INTO rent_posts ( name, phone, room_addr, room_area, room_type, room_orientation, room_floor, description, price, restriction, create_by, uuid, release_time, passed )
